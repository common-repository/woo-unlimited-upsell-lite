...
<?php
$settings_tabs = WooCommerce_Unlimited_Upsell_Settings::$settings_tabs;
?>
...
<div class="wrap">
    ...
    <h2 class="nav-tab-wrapper">
        ...
        <a href="#<?php echo $tab_id; ?>" class="nav-tab"><?php _e($tab, 'woocommerce-unlimited-upsell');?></a>
        <?php }?>
    </h2>
                    ...
                    <div class="postbox">
                        <div class="inside">
                            ...
                            <form id="plugin-settings-form" action="options.php" method="POST">
                                <?php
settings_fields(WooCommerce_Unlimited_Upsell_Settings::$settings_group_id);
