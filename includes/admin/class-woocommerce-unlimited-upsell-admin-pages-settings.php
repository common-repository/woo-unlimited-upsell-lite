 ...
 *
 * @package   WooCommerce_Unlimited_Upsell_Admin_Pages_Settings
 * @author    KungWoo
 * @license   GPL-2.0+
...
class WooCommerce_Unlimited_Upsell_Admin_Pages_Settings
{
    ...
    public function add_plugin_admin_menu()
    {
        ...
        $this->plugin_screen_hook_suffix['settings'] = add_submenu_page(
            ...
            __('Settings', 'woocommerce-unlimited-upsell'),
            __('Settings', 'woocommerce-unlimited-upsell'),
            'manage_options',
